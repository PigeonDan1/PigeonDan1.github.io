...
<div style="text-align: right; margin-bottom: 20px;">
  <a href="/about/">English</a> | <strong>中文</strong>
</div>
...
<div class="info-grid">
  <div class="info-card">
    ...
    <div>
      ...
      <p class="info-value">2003年10月6日</p>
    </div>
  </div>
  <div class="info-card">
    <div class="info-icon">📍</div>
  ...
  <div class="info-card">
    ...
    <div>
      ...
      <p class="info-value"><a href="https://scholar.google.com/citations?user=Uo0mj0AAAAAJ&hl=en" target="_blank">个人主页</a></p>
    </div>
  </div>
  <div class="info-card">
    <div class="info-icon">🔬</div>
    <div>
      ...
      <p class="info-value"><a href="https://www.semanticscholar.org/author/Jing-Peng/2327961941" target="_blank">个人主页</a></p>
    </div>
  </div>
  <div class="info-card">
    <div class="info-icon">🔗</div>
    <div>
      ...
      <p class="info-value"><a href="https://www.linkedin.com/in/jing-peng-7ab8682a4/" target="_blank">个人主页</a></p>
    </div>
  </div>
</div>
...
<div class="timeline">
  <div class="timeline-item">
    <div class="timeline-content">
      <div class="timeline-date">2025年9月 – 至今</div>
      <div class="timeline-school">上海交通大学 (SJTU)</div>
      <p class="timeline-degree"><strong>致远荣誉博士项目</strong>，X-LANCE Lab，计算机科学与工程系</p>
      <p class="timeline-detail">博士生</p>
    </div>
  </div>
  <div class="timeline-item">
    <div class="timeline-content">
      <div class="timeline-date">2021年9月 – 2025年6月</div>
      <div class="timeline-school">西安交通大学 (XJTU)</div>
      <p class="timeline-degree"><strong>自动化专业学士</strong>，辅修电气工程</p>
      <p class="timeline-detail">钱学森荣誉班</p>
    </div>
  </div>
  <div class="timeline-item">
    <div class="timeline-content">
      <div class="timeline-date">2023年8月 – 2023年12月</div>
      <div class="timeline-school">加州大学伯克利分校 (UC Berkeley)</div>
      <p class="timeline-degree"><strong>交换生</strong>，Berkeley Global Access (BGA)，工程学院</p>
    </div>
  </div>
</div>
...
总体而言，我专注于用于语音理解和推理的<strong>语音大语言模型 (Speech LLMs)</strong>：

<div class="interest-tags">
  <span class="interest-tag">🎙️ 说话人归属 ASR (SA-ASR)</span>
  <span class="interest-tag">🔗 多模态对齐</span>
  <span class="interest-tag">⚡ 高效自适应</span>
</div>
...
<div class="pub-scroll-section">
  <div class="pub-scroll-container">
    <div class="pub-scroll-wrapper" id="pubScrollAboutZh">
    ...
    <div class="pub-scroll-nav">
      <button class="pub-scroll-btn" onclick="document.getElementById('pubScrollAboutZh').scrollBy({top:-150,behavior:'smooth'})" aria-label="向上滑动">▲</button>
      <button class="pub-scroll-btn" onclick="document.getElementById('pubScrollAboutZh').scrollBy({top:150,behavior:'smooth'})" aria-label="向下滑动">▼</button>
    </div>
  </div>
</div>
...
<a href="/resume/" class="resume-cta">📄 查看或下载我的简历</a>
...
我来自<strong>中国湖南省衡阳市</strong>，一座美丽的城市。在科研之余，我喜欢<strong>探索美食</strong>和<strong>旅行</strong>，我也是<strong>羽毛球</strong>和<strong>篮球</strong>等运动的爱好者。
<br><br>
如果您对我的研究方向感兴趣，<strong>欢迎联系我</strong>——我很乐意讨论潜在的合作机会。
</div>
